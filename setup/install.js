...
`);
    ...
    if (!fs.existsSync(guidelinesPath)) {
        fs.writeFileSync(guidelinesPath, `# LunaBlueAI Usage Guidelines
...
`);
    ...
    if (!fs.existsSync(valuesPath)) {
        fs.writeFileSync(valuesPath, `# LunaBlueAI Core Values
